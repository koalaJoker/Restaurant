                            ...
                            <div class="row">
                                <div class="multi-gd-img">
                                    <ul class="multi-column-dropdown">
                                        <h6>All Groceries</h6>
                                        <li><a href="food.html">Dals & Pulses</a></li>
                                        <li><a href="food.html">Almonds</a></li>
                                        <li><a href="food.html">Cashews</a></li>
                                        <li><a href="food.html">Dry Fruit</a></li>
                                        <li><a href="food.html"> Mukhwas </a></li>
                                        <li><a href="food.html">Rice & Rice Products</a></li>
                                    </ul>
                                </div>
